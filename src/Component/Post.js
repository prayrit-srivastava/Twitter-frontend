...
function Post({ind, postUrl,id}){
    ...
    // async function handleisLiked(){

    //     // console.log(requestBody);
    //     const res = await axios.get(`http://localhost:3000/api/like/isLiked?userId=${userid}&postId=${id}`)
    ...
    <div className='container'>
        ...
        <div>
            <div className="Postheader">
                ...
                {/* <p style={{paddingLeft:'10px'}}>Time</p> */}
            ...
            <div className='imagecontainer'>
                <img className="image" src={post.ImageUrl} alt='postimage'/>
            </div>
